...
RcppExport SEXP _cRacle_findcoord(SEXP lonSEXP, SEXP latSEXP, SEXP distSEXP, SEXP brngSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _cRacle_latlonfromcell(SEXP cellsSEXP, SEXP extentSEXP, SEXP nrowSEXP, SEXP ncolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _cRacle_pythagorean(SEXP startSEXP, SEXP endSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type start(startSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_cRacle_distance", (DL_FUNC) &_cRacle_distance, 2},
    {"_cRacle_findcoord", (DL_FUNC) &_cRacle_findcoord, 4},
    {"_cRacle_latlonfromcell", (DL_FUNC) &_cRacle_latlonfromcell, 4},
    {"_cRacle_pythagorean", (DL_FUNC) &_cRacle_pythagorean, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_cRacle(DllInfo *dll) {
